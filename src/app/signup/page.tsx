    ...
    <main className="flex h-full flex-col items-center justify-center p-24">
      <div className="border border-lake-blue" id="form">
        ...
        <div className="flex flex-col items-center gap-4 px-10 py-6" id="form-content">
          <button className="rounded-full border border-lake-blue px-5 py-3 uppercase text-lake-blue">continue with google</button>
          ...
          <button className="rounded-full bg-lake-blue px-5 py-3 uppercase text-white">done</button>
        </div>
      </div>
    </main>
  );
