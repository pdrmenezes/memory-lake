  ...
  return (
    <main className="flex h-full w-full flex-col items-start justify-between">
      <div className="flex w-full flex-col" id="form">
        ...
        <div
          className="mb-4 grid grid-cols-3 grid-rows-2 gap-2 border-b-2 border-b-lake-blue pb-4 uppercase text-lake-blue"
          id="form-date"
        >
        ...
        >
          ...
          <span className="col-span-full col-start-1 ml-6 whitespace-pre-line text-xs uppercase text-lake-gray">
            you can send 5 memories to people of your choice per month. sent by email. mementos expire in first day of
            the month.
          </span>
        </div>
        <div
      ...
      <div className="flex w-full justify-between px-12 py-12">
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={() => signOut()}
            className="inline-block rounded-full border-2 border-white bg-lake-blue px-3 py-1 uppercase text-white hover:border-lake-blue hover:bg-white hover:text-lake-blue"
          >
            logout
          </button>
        </div>
